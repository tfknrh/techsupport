...
class AddFormulirsScreentest extends StatefulWidget {
  final bool isEdit;
...
class _GroupListScreenState extends State<AddFormulirsScreentest> {
  ...
  void getListForm() async {
    ...
    if (widget.formValue != null) {
      ...
      for (int i = 0; i < listValue.length; i++) {
        ...
        listFormulir[i].isCheck = listValue[i] != "" ? true : false;
