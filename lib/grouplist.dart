...
class _GroupListScreenState extends State<GroupList> {
  ...
  void getListForm() async {
    // listFormulir.clear();
    //  _controllers.clear();
    listFormulir = await DataBaseMain.getFormulirByCategoryID(2);
    ...
    if (widget.formValue != null) {
      ...
      for (int i = 0; i < listValue.length; i++) {
        ...
        listFormulir[i].isCheck = listValue[i] == "ok" ? true : false;
          ...
          IconButton(
            onPressed: () async {
              ...
              listdata.forEach((key, value) {
                templistValue.addAll(value.toList().map((e) => e.formValue));
              });
        ...
        groupHeaderBuilder: (BuildContext context, int section) {
          return Padding(
            ...
            child: Text(listdata.keys.toList()[section],
                style:
                    CText.primarycustomText(2.0, context, 'CircularStdBold')),
          );
        },
